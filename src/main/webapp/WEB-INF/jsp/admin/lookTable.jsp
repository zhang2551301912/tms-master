        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加课表','addCourseTable',600,400)"><i class="layui-icon"></i>添加</button>
                </div>
                    ...
                    <table class="layui-table layui-form">
                        ...
                        <c:forEach items="${courseTable}" var="ct">
                            <tr>
                                ...
                                <td class="td-manage">
                                    <a title="编辑"  onclick="xadmin.open('编辑','updateCourseTable?id=${ct.id}',600,400)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                    </a>
                                    <a title="删除" onclick="member_del(this,'${ct.id}')" href="javascript:;">
                                        <i class="layui-icon">&#xe640;</i>
                                    </a>
                                </td>
                            </tr>
...
<script>
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            //发异步删除数据
            parm={id:id}
            url= "${pageContext.request.contextPath}/admin/deleteCourseTable";
    ...
    function delAll (argument) {
        ...
        layer.confirm('确认要删除吗？'+ids.toString(),function(index){
            //捉到所有被选中的，发异步进行删除
            $.ajax({
                url:"${pageContext.request.contextPath}/admin/batchDeleteCourseTable",
                data:{ids:ids},
                type:"Post",
                dataType: "json",
                traditional:true,
