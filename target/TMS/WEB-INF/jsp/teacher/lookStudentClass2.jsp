                                ...
                                <tbody>
                     				<c:forEach items="${studentCourse}" var="studentCourse">
                     					<tr>
                                            ...
                                            <td><input id="${studentCourse.id}" value="${studentCourse.id}" type="checkbox" name="status" lay-skin="switch" lay-filter="status"${studentCourse.status=='1' ? 'checked' : '0'} lay-text="确认|取消"></td>
                                    	</tr>
                     				</c:forEach>	                                                                                     
                                </tbody>
                            </table>
