                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加学生','addStudentClass2',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
                     				...
                     				<c:forEach items="${stu_class}" var="stu_class">
                     					<tr>
                                            ...
                                            <td><input id="${stu_class.user_id}" value="${stu_class.user_id}" type="checkbox" name="status" lay-skin="switch" lay-filter="status"${stu_class.status=='1' ? 'checked' : '0'} lay-text="ON|OFF"></td>
	                     					<td class="td-manage">
	                     					  <a title="编辑"  onclick="xadmin.open('编辑','updateStudentClass2?id=${stu_class.id}',600,400)" href="javascript:;">
