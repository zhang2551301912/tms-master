...
<body>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
						<div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加角色','addRole',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                     				<c:forEach items="${roles}" var="role">
                     					<tr>
                                            <td><input type="checkbox" value="${role.role_id}" lay-filter="check" name="" lay-skin="primary"></td>
                     						<td>${role.role_id}</td>
	                     					<td>${role.name}</td>
	                     					<td class="td-manage">
                                              <a title="编辑"  onclick="xadmin.open('编辑','updateRole?role_id=${role.role_id}',600,400)" href="javascript:;">
    ...
    <script>
      ...
      function delAll (argument) {
          ...
          layer.confirm('确认要删除吗？'+role_ids.toString(),function(index){
              //捉到所有被选中的，发异步进行删除
              $.ajax({
                  url:"${pageContext.request.contextPath}/admin/batchDeleteRole",
